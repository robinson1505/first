...
describe("MyERC20Contract", function () {
  ...
  beforeEach(async function () {
    const ERC20ContactFactory = await ethers.getContractFactory("ERC20");
    // Deploy contract
    myERC20Contract = await ERC20ContactFactory.deploy("hello", "SYM");
  ...
  describe("When i have 10 tokens", function () {
    ...
    describe("when i transfer 10 tokens", function () {
      it("Should transfer token correctly", async function () {
        ...
        expect(
          await myERC20Contract.balancesOf(someOtherAddress.address)
        ).to.equal(10);
      });
    });
    ...
    describe("when i transfer 15 tokens", function () {
      it("should revert the transaction", async function () {
        ...
        ).to.be.revertedWith("ERC20:transfer amount exceed the balance");
      });
    });
  });
});
